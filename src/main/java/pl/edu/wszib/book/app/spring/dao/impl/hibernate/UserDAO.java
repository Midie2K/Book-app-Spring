...
public class UserDAO implements IUserDAO {
    private final String GET_BY_LOGIN = "FROM pl.edu.wszib.book.app.spring.model.User WHERE login = :login";
    private final String GET_BY_ID = "FROM pl.edu.wszib.book.app.spring.model.User WHERE id = :id";
    private final String GET_ALL = "FROM pl.edu.wszib.book.app.spring.model.User";
